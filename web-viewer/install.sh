#!/usr/bin/env bash
# One-click installer for the Web Viewer (Part 3).
...
if [ ! -f .env ]; then
  ...
  cp .env.example .env
  echo "NOTE: set ENGINE_URL in .env to your Broadcasting Engine address."
fi

echo
echo "============================================================"
echo " Done! Start the viewer with:  bash run.sh"
echo " (or: $VENV_PY app.py)"
echo " Then open http://localhost:8080/live"
echo "============================================================"
